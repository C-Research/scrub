...
### Requirement: Source directory mounted read-only
The system SHALL treat the source directory as read-only. No source file SHALL be modified, moved, or deleted.
